 ...
 const [icptokenName, setIcpTokenName] = useState("");
  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-white">Bridging Real-World Finance and Blockchain Freedom</h1>
        <p className="mb-8 text-lg font-normal  lg:text-xl sm:px-16 xl:px-48 text-gray-400">Tokenized mutual funds, bonds, and stocks. Trade seamlessly. Earn confidently.</p>
