 ...
 const [icptokenName, setIcpTokenName] = useState("");
  ...
  return (
    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Tokenized mutual funds, bonds, and stocks. Trade seamlessly. Earn confidently.</p>
