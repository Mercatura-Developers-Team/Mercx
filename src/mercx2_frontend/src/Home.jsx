          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8 mb-8">
              ...
              <div className="space-y-4">
                ...
                <img src={'j.png'} alt="Logo" className="h-10 sm:h-12 mt-2 mr-3 " />
           ...
           <a href="https://www.linkedin.com/company/mercxx/" className="text-gray-400 hover:text-blue-400 transition-colors">
  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
