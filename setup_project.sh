...
dfx deploy icrc1_index_canister --argument '(opt variant{Init = record {ledger_id = principal "be2us-64aaa-aaaaa-qaabq-cai"; retrieve_blocks_from_ledger_interval_seconds = opt 10}})'

dfx deploy fxmx_icrc1_index --argument '(opt variant{Init = record {ledger_id = principal "bkyz2-fmaaa-aaaaa-qaaaq-cai"; retrieve_blocks_from_ledger_interval_seconds = opt 86400}})'
...
dfx deploy tommy_icrc1_index --argument '(opt variant{Init = record {ledger_id = principal "by6od-j4aaa-aaaaa-qaadq-cai"; retrieve_blocks_from_ledger_interval_seconds = opt 86400}})'
...
dfx deploy icp_index_canister --specified-id qhbym-qaaaa-aaaaa-aaafq-cai --argument '(record {ledger_id = principal "asrmz-lmaaa-aaaaa-qaaeq-cai"})'
